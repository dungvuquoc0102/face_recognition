!(function (t, e) {
	...
	var Mt,
		...
		Ft = (function () {
			function t(t, e, n) {
				(this.backend = t), (this.safeMode = e), (this.debugMode = n), (this.registeredVariables = {}), (this.nextTapeNodeId = 0), (this.numBytes = 0), (this.numTensors = 0), (this.numStringTensors = 0), (this.numDataBuffers = 0), (this.profiling = !1), (this.gradientDepth = 0), (this.kernelDepth = 0), (this.scopeStack = []), (this.nextScopeId = 0), (this.tensorInfo = new WeakMap()), (this.profiler = new et(t)), (this.activeProfile = { newBytes: 0, newTensors: 0, peakBytes: 0, kernels: [], result: null });
			}
			return (
				...
				(t.prototype.registerTensor = function (t, e) {
					...
					if ((this.numTensors++, "string" === t.dtype && this.numStringTensors++, 0 === n)) {
						this.numDataBuffers++;
						var r = 0;
						"complex64" !== t.dtype && "string" !== t.dtype && (r = t.size * U(t.dtype)), this.tensorInfo.set(t.dataId, { backend: null != e ? e : this.backend, dtype: t.dtype, shape: t.shape, bytes: r, refCount: 0 }), (this.numBytes += r), null != e ? e.register(t.dataId, t.shape, t.dtype) : this.backend.register(t.dataId, t.shape, t.dtype);
					}
	...
	var va = (function () {
		...
		return (
			...
			(t.prototype.startTimer = function () {
				return 0 < Zt.get("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION") ? this.gpgpu.beginQuery() : { startMs: performance.now(), endMs: null };
			}),
			...
			(t.prototype.compileAndRun = function (o, t, e, n, r) {
				...
				var s,
					u = { shape: e.shape, texData: this.texData.get(e.dataId), isUniform: !1 },
					c = (function (t, e, n) {
						var r = "";
	...
	function Qc(t) {
		...
		return { dateSaved: new Date(), modelTopologyType: "JSON", modelTopologyBytes: null == t.modelTopology ? 0 : Kc(JSON.stringify(t.modelTopology)), weightSpecsBytes: null == t.weightSpecs ? 0 : Kc(JSON.stringify(t.weightSpecs)), weightDataBytes: null == t.weightData ? 0 : t.weightData.byteLength };
	}
	var Jc = (function () {
			function i() {
	...
	var hl = "/",
		...
		gl = "model_metadata";
	function yl(t) {
		return { info: [pl, t, fl].join(hl), topology: [pl, t, dl].join(hl), weightSpecs: [pl, t, vl].join(hl), weightData: [pl, t, ml].join(hl), modelMetadata: [pl, t, gl].join(hl) };
	}
	function xl(t) {
		var e = t.split(hl);
						...
						switch (t.label) {
							case 0:
								...
								return (
									...
									(r = { modelTopology: i.modelTopology, format: i.format, generatedBy: i.generatedBy, convertedBy: i.convertedBy, weightsManifest: n }),
									e.body.append("model.json", new Blob([JSON.stringify(r)], { type: "application/json" }), "model.json"),
									null != i.weightData && e.body.append("model.weights.bin", new Blob([i.weightData], { type: "application/octet-stream" }), "model.weights.bin"),
						...
						switch (t.label) {
							case 0:
								...
								return (
									...
									[4, Rl(f, { requestInit: this.requestInit, fetchFunc: this.getFetchFunc(), onProgress: this.onProgress })]
								);
							case 1:
		...
		Sh = (function () {
			...
			return (
				...
				(l.prototype.calibrate = function (t) {
					return new l({ left: this.left + t.left * this.width, top: this.top + t.top * this.height, right: this.right + t.right * this.width, bottom: this.bottom + t.bottom * this.height }).toSquare().round();
				}),
				l
			);
		})(),
	...
	var jp = (function (t) {
		...
		return (
			...
			(e.prototype.extractParamsFromWeigthMap = function (t) {
				return (r = qp((e = t), (n = [])).extractDenseBlock4Params), (o = { dense0: r("dense0", !0), dense1: r("dense1"), dense2: r("dense2"), dense3: r("dense3") }), Xh(e, n), { params: o, paramMappings: n };
				var e, n, r, o;
			}),
			...
			l =
				...
				(i = Zh(n, r)),
				{
					...
					extractReductionBlockParams: function (t, e, n) {
						return { separable_conv0: i(t, e, n + "/separable_conv0"), separable_conv1: i(e, e, n + "/separable_conv1"), expansion_conv: o(t, e, 1, n + "/expansion_conv") };
					},
					extractMainBlockParams: function (t, e) {
						return { separable_conv0: i(t, t, e + "/separable_conv0"), separable_conv1: i(t, t, e + "/separable_conv1"), separable_conv2: i(t, t, e + "/separable_conv2") };
					}
				}),
	...
	var Cf = (function (t) {
			...
			return (
				...
				(e.prototype.extractParamsFromWeigthMap = function (t) {
					return (r = qp((e = t), (n = [])).extractDenseBlock3Params), (o = { dense0: r("dense0", !0), dense1: r("dense1"), dense2: r("dense2") }), Xh(e, n), { params: o, paramMappings: n };
					var e, n, r, o;
				}),
				(e.prototype.extractParams = function (t) {
					return (function (t) {
		...
		return {
			...
			extractPredictionLayerParams: function () {
				return {
					...
					box_predictor_0: { box_encoding_predictor: i(512, 12, 1, "prediction_layer/box_predictor_0/box_encoding_predictor"), class_predictor: i(512, 9, 1, "prediction_layer/box_predictor_0/class_predictor") },
					box_predictor_1: { box_encoding_predictor: i(1024, 24, 1, "prediction_layer/box_predictor_1/box_encoding_predictor"), class_predictor: i(1024, 18, 1, "prediction_layer/box_predictor_1/class_predictor") },
					box_predictor_2: { box_encoding_predictor: i(512, 24, 1, "prediction_layer/box_predictor_2/box_encoding_predictor"), class_predictor: i(512, 18, 1, "prediction_layer/box_predictor_2/class_predictor") },
					box_predictor_3: { box_encoding_predictor: i(256, 24, 1, "prediction_layer/box_predictor_3/box_encoding_predictor"), class_predictor: i(256, 18, 1, "prediction_layer/box_predictor_3/class_predictor") },
					box_predictor_4: { box_encoding_predictor: i(256, 24, 1, "prediction_layer/box_predictor_4/box_encoding_predictor"), class_predictor: i(256, 18, 1, "prediction_layer/box_predictor_4/class_predictor") },
					box_predictor_5: { box_encoding_predictor: i(128, 24, 1, "prediction_layer/box_predictor_5/box_encoding_predictor"), class_predictor: i(128, 18, 1, "prediction_layer/box_predictor_5/class_predictor") }
				};
			}
		};
	}
	...
	function Gf(t, e) {
		var n,
			r,
			o = ((n = ha(Qu(t, [1, 0]))), { sizes: (r = [Bu(n[2], n[0]), Bu(n[3], n[1])]), centers: [xu(n[0], Cu(r[0], Ve(2))), xu(n[1], Cu(r[1], Ve(2)))] }),
			i = o.sizes,
			a = o.centers,
			s = ha(Qu(e, [1, 0])),
	...
	var hd = (function (t) {
									...
									case 3:
										return (
											...
											(b = w.boxes.map(function (e, t) {
												return of(
													Wp({}, new Lp(w.scores[t], new Th(e.left / c, e.top / u, e.width / c, e.height / u), { height: u, width: c })),
													new mf(
		...
		dd = (function (e) {
			function t() {
				var t = { withSeparableConvs: !0, iouThreshold: 0.4, classes: ["face"], anchors: pd, meanRgb: fd, isFirstLayerConv2d: !0, filterSizes: [3, 16, 32, 64, 128, 256, 512] };
		...
		yd = (function (n) {
			function t(t) {
				void 0 === t && (t = !0);
				var e = Object.assign({}, { withSeparableConvs: t, iouThreshold: 0.4, classes: ["face"] }, t ? { anchors: md, meanRgb: gd } : { anchors: vd, withClassScores: !0 });
